...
var modelica = {
	...
	token: function(stream, state) {
		...
		var ch = stream.next();
		if (ch == "/" && stream.eat("/")) state.tokenize = tokenLineComment;
		else if (ch == "/" && stream.eat("*")) state.tokenize = tokenBlockComment;
		...
		else if (ch == "\"") state.tokenize = tokenString;
...
//# sourceMappingURL=modelica-Dl0c7bKN.js.map