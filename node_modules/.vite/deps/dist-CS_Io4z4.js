...
import { A as syntaxTree, B as Tree, C as indentNodeProp, Ct as countColumn, E as languageDataProp, F as NodeProp, I as NodeSet, L as NodeType, M as styleTags, N as tags, T as indentUnit, V as parseMixed, W as EditorView, X as keymap, b as foldService, c as Language, d as ParseContext, h as defineLanguageFacet, j as Tag, l as LanguageDescription, lt as EditorSelection, pt as Prec, u as LanguageSupport, ut as EditorState, y as foldNodeProp, z as Parser } from "./dist-CrgB1_Ed.js";
import { t as CompletionContext } from "./dist-B3L2jJf_.js";
import { n as html, r as htmlCompletionSource } from "./dist-BCAJ2nli.js";
...
var EmptyLine = /^[ \t]*$/, CommentEnd = /-->/, ProcessingEnd = /\?>/;
var HTMLBlockStyle = [
...
//#endregion
//#region node_modules/@codemirror/lang-markdown/dist/index.js
var dist_exports = /* @__PURE__ */ __exportAll({
	...
	insertNewlineContinueMarkupCommand: () => insertNewlineContinueMarkupCommand,
	markdown: () => markdown,
	markdownKeymap: () => markdownKeymap,
	markdownLanguage: () => markdownLanguage,
	pasteURLAsLink: () => pasteURLAsLink
});
var data = /* @__PURE__ */ defineLanguageFacet({ commentTokens: { block: {
	open: "<!--",
	close: "-->"
} } });
var headingProp = /* @__PURE__ */ new NodeProp();
var commonmark = /* @__PURE__ */ parser.configure({ props: [
...
*/
var markdownLanguage = /* @__PURE__ */ mkLang(/* @__PURE__ */ commonmark.configure([
	GFM,
	Subscript,
	Superscript,
	Emoji,
...
*/
var pasteURLAsLink = /* @__PURE__ */ EditorView.domEventHandlers({ paste: (event, view) => {
	var _a;
...
//#endregion
export { markdown as n, dist_exports as t };

//# sourceMappingURL=dist-CS_Io4z4.js.map