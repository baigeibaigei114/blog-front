import { C as indentNodeProp, M as styleTags, N as tags, m as continuedIndent, n as ExternalTokenizer, r as LRParser, s as LRLanguage, u as LanguageSupport, v as foldInside, y as foldNodeProp } from "./dist-CrgB1_Ed.js";
//#region node_modules/@lezer/rust/dist/index.js
var closureParamDelim = 1, tpOpen = 2, tpClose = 3, RawString = 4, Float = 5;
var _b = 98, _e = 101, _f = 102, _r = 114, _E = 69, Zero = 48, Dot = 46, Plus = 43, Minus = 45, Hash = 35, Quote = 34, Pipe = 124, LessThan = 60, GreaterThan = 62;
function isNum(ch) {
	return ch >= 48 && ch <= 57;
}
function isNum_(ch) {
...
var literalTokens = new ExternalTokenizer((input, stack) => {
	if (isNum(input.next)) {
		...
		if (input.next == Dot) {
			isFloat = true;
			input.advance();
			if (isNum(input.next)) do
				input.advance();
			while (isNum_(input.next));
			else if (input.next == Dot || input.next > 127 || /\w/.test(String.fromCharCode(input.next))) return;
		}
...
//#endregion
//#region node_modules/@codemirror/lang-rust/dist/index.js
/**
...
//# sourceMappingURL=dist-D5xJViMs.js.map