import { A as syntaxTree, C as indentNodeProp, M as styleTags, N as tags, W as EditorView, lt as EditorSelection, n as ExternalTokenizer, p as bracketMatchingHandle, r as LRParser, s as LRLanguage, t as ContextTracker, u as LanguageSupport, y as foldNodeProp } from "./dist-CrgB1_Ed.js";
...
function valueCompletion(spec) {
	return typeof spec == "string" ? {
		label: `"${spec}"`,
		type: "constant"
	} : /^"/.test(spec.label) ? spec : Object.assign(Object.assign({}, spec), { label: `"${spec.label}"` });
}
/**
...
var xmlLanguage = /* @__PURE__ */ LRLanguage.define({
	...
	parser: /* @__PURE__ */ parser.configure({ props: [
		...
		/* @__PURE__ */ foldNodeProp.add({ Element(subtree) {
...
*/
function xml(conf = {}) {
	let support = [xmlLanguage.data.of({ autocomplete: completeFromSchema(conf.elements || [], conf.attributes || []) })];
...
var autoCloseTags = /* @__PURE__ */ EditorView.inputHandler.of((view, from, to, text, insertTransaction) => {
	...
	let closeTags = state.changeByRange((range) => {
		...
		if (didType && text == ">" && after.name == "EndTag") {
			...
			if (((_b = (_a = tag.parent) === null || _a === void 0 ? void 0 : _a.lastChild) === null || _b === void 0 ? void 0 : _b.name) != "CloseTag" && (name = elementName(state.doc, tag.parent, head))) return {
				range,
				changes: {
					from: head,
...
//# sourceMappingURL=dist-DTLYmEp-.js.map