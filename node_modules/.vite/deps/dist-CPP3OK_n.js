import { M as styleTags, N as tags, V as parseMixed, n as ExternalTokenizer, r as LRParser, s as LRLanguage, u as LanguageSupport } from "./dist-CrgB1_Ed.js";
import "./dist-B3L2jJf_.js";
import { n as html } from "./dist-BCAJ2nli.js";
import "./dist-Cz-5Y8sD.js";
import { r as javascriptLanguage } from "./dist-CwY0l3D4.js";
//#region node_modules/@codemirror/lang-angular/dist/index.js
var Text = 1, attributeContentSingle = 33, attributeContentDouble = 34, scriptAttributeContentSingle = 35, scriptAttributeContentDouble = 36;
var text = /* @__PURE__ */ new ExternalTokenizer((input) => {
	...
	for (;;) {
		if (input.next == 10) {
			input.advance();
			break;
		} else if (input.next == 123 && input.peek(1) == 123 || input.next < 0) break;
		input.advance();
	}
...
var baseParser = /* @__PURE__ */ parser.configure({ props: [/* @__PURE__ */ styleTags({
	Text: tags.content,
...
var exprMixed = { parser: exprParser }, statementMixed = { parser: javascriptLanguage.parser };
...
var textMixed = { parser: textParser }, attrMixed = { parser: attrParser };
...
function mixAngular(node, input) {
	switch (node.name) {
		case "Attribute": return /^[*#(\[]|\{\{/.test(input.read(node.from, node.to)) ? attrMixed : null;
...
//# sourceMappingURL=dist-CPP3OK_n.js.map