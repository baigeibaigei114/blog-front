import { A as syntaxTree, C as indentNodeProp, M as styleTags, N as tags, V as parseMixed, W as EditorView, g as delimitedIndent, i as LocalTokenGroup, lt as EditorSelection, n as ExternalTokenizer, r as LRParser, s as LRLanguage, u as LanguageSupport, y as foldNodeProp } from "./dist-CrgB1_Ed.js";
import "./dist-B3L2jJf_.js";
import { n as html } from "./dist-BCAJ2nli.js";
import "./dist-Cz-5Y8sD.js";
import "./dist-CwY0l3D4.js";
//#region node_modules/@codemirror/lang-jinja/dist/index.js
...
var parser = /* @__PURE__ */ LRParser.deserialize({
	...
	tokenizers: [
		...
		4,
		5,
		/* @__PURE__ */ new LocalTokenGroup("b~RPstU~XP#q#r[~aO$Q~~", 17, 173)
	],
...
function findContext(context) {
	...
	if (context.explicit && (before == "FilterOp" || before == "filter")) return { type: "filter" };
...
function jinjaCompletionSource(config = {}) {
	...
	return (context) => {
		...
		else options = properties ? resolveProperties(context.state, cx.target, context, properties) : [];
...
var tagLanguage = /* @__PURE__ */ LRLanguage.define({
	...
	parser: /* @__PURE__ */ parser.configure({ props: [
		...
		/* @__PURE__ */ foldNodeProp.add({ "Statement Comment"(tree) {
...
//# sourceMappingURL=dist-BxE90KTF.js.map