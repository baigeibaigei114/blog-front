...
for (var idx in Rules) {
	var r = Rules[idx];
	if (r.splice) for (var i = 0, len = r.length; i < len; ++i) {
		var rr = r[i];
		if (typeof rr.regex === "string") Rules[idx][i].regex = new RegExp("^" + rr.regex);
	}
	else if (typeof rr.regex === "string") Rules[idx].regex = new RegExp("^" + r.regex);
}
var liveScript = {
	name: "livescript",
	startState: function() {
...
//# sourceMappingURL=livescript-LBXf6JuG.js.map