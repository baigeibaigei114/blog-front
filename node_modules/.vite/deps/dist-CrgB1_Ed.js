	...
	getIndent(cx) {
		...
		while (statePos < cx.pos) {
			...
			if (line.length) {
				...
				let stream = new StringStream(line.text, cx.state.tabSize, cx.unit, indentation < 0 ? void 0 : indentation);
				while (stream.pos < end - line.from) readToken$1(this.streamParser.token, stream, state);
...
//#endregion
export { runScopeHandlers as $, syntaxTree as A, Tree as B, indentNodeProp as C, countColumn as Ct, matchBrackets as D, languageDataProp as E, NodeProp as F, ViewPlugin as G, Decoration as H, NodeSet as I, getPanel as J, WidgetType as K, NodeType as L, styleTags as M, tags as N, sublanguageProp as O, IterMode as P, placeholder as Q, NodeWeakMap as R, getIndentation as S, combineConfig as St, indentUnit as T, fromCodePoint as Tt, Direction as U, parseMixed as V, EditorView as W, keymap as X, getTooltip as Y, logException as Z, flatIndent as _, StateField as _t, HighlightStyle as a, ChangeDesc as at, foldService as b, codePointAt as bt, Language as c, Compartment as ct, ParseContext as d, Facet as dt, showDialog as et, StreamLanguage as f, MapMode as ft, delimitedIndent as g, StateEffect as gt, defineLanguageFacet as h, RangeValue as ht, LocalTokenGroup as i, Annotation as it, Tag as j, syntaxHighlighting as k, LanguageDescription as l, EditorSelection as lt, continuedIndent as m, RangeSetBuilder as mt, ExternalTokenizer as n, showTooltip as nt, IndentContext as o, ChangeSet as ot, bracketMatchingHandle as p, Prec as pt, drawSelection as q, LRParser as r, crelt as rt, LRLanguage as s, CharCategory as st, ContextTracker as t, showPanel as tt, LanguageSupport as u, EditorState as ut, foldInside as v, Text as vt, indentString as w, findClusterBreak as wt, getIndentUnit as x, codePointSize as xt, foldNodeProp as y, Transaction as yt, Parser as z };

//# sourceMappingURL=dist-CrgB1_Ed.js.map