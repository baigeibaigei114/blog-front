import { A as syntaxTree, C as indentNodeProp, M as styleTags, N as tags, V as parseMixed, W as EditorView, g as delimitedIndent, lt as EditorSelection, n as ExternalTokenizer, r as LRParser, s as LRLanguage, u as LanguageSupport, y as foldNodeProp } from "./dist-CrgB1_Ed.js";
import "./dist-B3L2jJf_.js";
import { n as html } from "./dist-BCAJ2nli.js";
import "./dist-Cz-5Y8sD.js";
import "./dist-CwY0l3D4.js";
//#region node_modules/@codemirror/lang-liquid/dist/index.js
		...
		if (next == 123) {
			...
			if (after == 123) {
				...
				for (;;) {
					...
					} else if (next == 45 && size == 2) size = ++scan;
					else {
						let end = next == 101 && input.peek(scan + 1) == 110 && input.peek(scan + 2) == 100;
...
function findContext(context) {
	...
	if (context.explicit && node.name != "CommentText" && node.name != "StringLiteral" && node.name != "NumberLiteral" && node.name != "InlineComment") return { type: "expression" };
	return null;
}
...
cursor between them.
*/
var closePercentBrace = /* @__PURE__ */ EditorView.inputHandler.of((view, from, to, text) => {
...
var tagLanguage = /* @__PURE__ */ LRLanguage.define({
	...
	parser: /* @__PURE__ */ parser.configure({ props: [
		...
		/* @__PURE__ */ foldNodeProp.add({ "UnlessDirective ForDirective TablerowDirective CaptureDirective IfDirective CaseDirective RawDirective Comment"(tree) {
...
function makeLiquid(base) {
	return tagLanguage.configure({ wrap: parseMixed((node) => node.type.isTop ? {
		parser: base.parser,
...
//# sourceMappingURL=dist-C2-D0zku.js.map