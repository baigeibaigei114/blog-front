//#region node_modules/@codemirror/legacy-modes/mode/solr.js
var isStringChar = /[^\s\|\!\+\-\*\?\~\^\&\:\(\)\[\]\{\}\"\\]/;
var isOperatorChar = /[\|\!\+\-\*\?\~\^\&]/;
...
function tokenWord(ch) {
	return function(stream, state) {
		var word = ch;
		while ((ch = stream.peek()) && ch.match(isStringChar) != null) word += stream.next();
		state.tokenize = tokenBase;
...
//# sourceMappingURL=solr-CRIRhvMI.js.map