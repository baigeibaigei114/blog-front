...
var commonLisp = {
	...
	token: function(stream, state) {
		...
		if (type != "ws") {
			if (state.ctx.indentTo == null) if (type == "symbol" && assumeBody.test(stream.current())) state.ctx.indentTo = state.ctx.start + stream.indentUnit;
...
//# sourceMappingURL=commonlisp-WfU9oF1y.js.map