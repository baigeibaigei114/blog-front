...
var dtd = {
	...
	indent: function(state, textAfter, cx) {
		...
		if (textAfter.charAt(0) === "]") n--;
			...
			if (textAfter.substr(0, 1) === "<") {} else if (type == "doindent" && textAfter.length > 1) {} else if (type == "doindent") n--;
			else if (type == ">" && textAfter.length > 1) {} else if (type == "tag" && textAfter !== ">") {} else if (type == "tag" && state.stack[state.stack.length - 1] == "rule") n--;
			else if (type == "tag") n++;
...
//# sourceMappingURL=dtd-Bga_FLT0.js.map